    ...
    features: [
      ...
      },
      {
        ...
        geometry: {
          ...
          coordinates: [
            ...
            ['@@C@EFH@LCAAG@'],
            ['@@IBCDLADAAA'],
            ['@@YFGFAFVHDDD@JAL@HABGK@BGAAMG'],
            ['@@BDLHBBRJFALADAC@@CFEB@DAGEEDEAAAMABCACCB@HCBC@CBCEGB'],
            ['@@G@CFEBADJDDAB@BHCFBBF@@HDADEDADDCB@DFDDAFEACDA@GIGKCI@DECA'],
            ['@@BBBAAAAB'],
            ['@@BBD@CECBBB'],
            ['@@A@BBBAA@'],
            ['@@@@BAA@@B'],
            ['@@DBACAB'],
            ['@@CBF@AA'],
            ['@@EDAFEB@FDDN@FFFBDE@EC@ECCAAKC@'],
            ['@@IBCD@HKFKJMDCCA@GF@@FBJADBF@J@DIFCTEDEFIIA'],
            ...
            ['@@@BD@HAEAEB'],
            [
              '@@MBKLGLAL@HJTDN@FCFIFCFAHDPBFF@VA\\GH@DBBFAFIJ@F@DF@TEHE@IEE@EBEVEHELS@KAIGKGG]MYYECM@',
            ],
            ['@@EBCD@FDFTHJGF@@ICCG@ADA@A@CCGC'],
            ['@@B@@EFCCCC@ABBBCFDD'],
            ['@@A@AB@AC@DDDAB@AA'],
            ['@@DBP@@CCCECCDGB@BABD@'],
            [
              '@@@FAHC@@BHDJ@@BAFKBABJD@DCDDBTABAAC@AGIAC@CDABEHEBCIECE@AIECDBBABIBDBED@BD@DB',
            ],
            ['@@HA@AG@CBDB'],
            ['@@DB@AAAC@CDBBBCB@'],
            ['@@DCACA@A@AFDB'],
            ...
            ['@@A@BB@A'],
            [
              '@@C@@ACA@ADAACBA@AG@@CE@@AEA@ACBA@A@BCEEEACBCCADE@EFBBA@ADC@@DEHGFIBBBADBB@DEFDDFB@DMTT@XDDD@BDFJBFDCHEFBBJBDAVAXDLFAF@BH@TFJDBDBAD@BDFAF@AEECC@@CK@ABABGAEI@CDA@@IAAI@@B@@AAA@CAA@EHEFABEHMCIDEDB@ADA@EH@@AEACCC@@DC@I@@B@@CDIDCA@CA@GDD@BDFB@FABIDCAEAABA@EAEC@CBAD@AGF@CE',
            ],
            ['@@BAC@@@BB'],
            ['@@BAA@CDDA'],
            ['@@ABBBFAAAC@'],
      ...
      },
      {
        ...
        geometry: {
          ...
          encodeOffsets: [[128111, 43499]],
        },
        properties: {
          cp: [123.921109, 41.875956],
          name: '抚顺市',
          childNum: 1,
        },
      },
