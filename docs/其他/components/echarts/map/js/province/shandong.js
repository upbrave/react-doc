    ...
    features: [
      ...
      },
      {
        ...
        geometry: {
          ...
          coordinates: [
            ...
            ['@@DABEC@CDBD'],
            ['@@D@BGBGCAG@@DADBJD@'],
            ['@@SHKCM@GCOBI@EF@DBDFBDFD@V@BBAJD@D@PEROL@BE@CCCC@'],
            ['@@HC@CAAE@ADGFDBFA'],
            ['@@BBD@BEEGA@CDBBBF'],
            ['@@H@BCCAID@BD@'],
            ['@@FAFEBCCCC@CBC@CB@D@DFD'],
            ['@@DDD@BABIAEEACB@N'],
            ['@@D@BACEA@ADBD'],
            ['@@BKFK@CACEBEDEDAD@FFNDBB@BC'],
            ['@@BFBBD@BAAGBCCECAAB@L'],
            ['@@LBBAECCBA@C@@BB@'],
            ['@@AB@BBC'],
            ['@@DA@AA@AB@B'],
            ['@@BA@AAB@B'],
            ...
            ['@@DA@EC@CBADFB'],
            ['@@DDBA@CACEDBB'],
            ['@@NHF@DAACA@C@EEQG@BHJ'],
            ['@@A@@DDAAA'],
            ['@@AB@BBA@A'],
            ['@@BBBAACAD'],
            ['@@TXDFDLJDJBBGAOFSBCJIDE@CAEGGGCUIMAIDEDCHAFBTDH'],
            ['@@DHHDBFDABEGIEABGCCC@CF@DDD'],
            ['@@DABC@EACE@EBBHFF'],
            ['@@ALBBDADCHMCAE@EH'],
            ['@@BACAADD@'],
            ['@@D@@ECF'],
      ...
      },
      {
        ...
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@EBCB@F@FHFLDDBBFHHF@D@HEPOBGBCCESFIEA@GDC@ME'],
            ['@@E@IDGFQTEF@FBFDDDBTBDDFABECE@ELADA@CAAIAAC@CJIBCCE'],
            ['@@AB@DFJ@BED@DFF@JDBHGDIJCBCIKEAOC'],
            ['@@GDAF@DBDJLJ\\HHJDZDL@NCJEDEBCCGIKOCW@EACCEMIEIAGA'],
            ['@@EHOJCF@ZJrBFBBF@DCHKNeDATALCNMFI@CEAYAWFG@EA@C@EACCC'],
            ['@@KBADAH@HFJDDF@B@JGDICKGEC@'],
            ['@@BDBACI@H'],
            ['@@E@GFGHCRBDB@JGJ@LCDI@GEEG@'],
            ['@@CFBFB@@CFBBCE@AE'],
            ['@@DABA@CACBCA@A@@DCDBH'],
            ['@@C@CFEEA@CB@FBDJF@FAF@DRH@HHBDMAOCICEIE'],
            ['@@A@AFBFDBDC@EEC'],
            ['@@@AA@BB'],
            ['@@BBBAFBJEAAGBBBA@CAADC@'],
            ['@@B@@@A@@@'],
            ['@@@BD@@AC@'],
            ['@@B@AA@B'],
            ['@@A@BB@A'],
      ...
      },
      {
        ...
        geometry: {
          ...
          encodeOffsets: [[118836, 36846]],
        },
        properties: {
          cp: [116.587245, 35.415393],
          name: '济宁市',
          childNum: 1,
        },
      },
      ...
      },
      {
        ...
        geometry: {
          ...
          coordinates: [
            ...
            ['@@A@@DB@@C'],
            [
              '@@@ACB@BGBACE@@BD@@BE@CFCDDBHCBBFB@DDBBHD@@BBBBCDA@CBAHBFCFDDAAABAAEDCFCDBDAD@FEBBFCAAKBE@WBO@GB',
            ],
            ['@@ABBA'],
            ['@@A@DBAA'],
            ['@@CDGA@BDDD@FEAA'],
      ...
      },
      {
        ...
        geometry: {
          ...
          encodeOffsets: [[120363, 38924]],
        },
        properties: {
          cp: [116.307428, 37.453968],
          name: '德州市',
          childNum: 1,
        },
      },
      ...
      },
      {
        ...
        geometry: {
          ...
          encodeOffsets: [[118658, 36728]],
        },
        properties: {
          cp: [115.469381, 35.246531],
          name: '菏泽市',
          childNum: 1,
        },
      },
