    ...
    features: [
      ...
      },
      {
        ...
        geometry: {
          ...
          coordinates: [
            [
              '@@F@JAJGHGPOJEBAEGDGBGEKAGDQDGZCTG@EKOJKmgWQDGCC@CFEDGFI@EECQKSC]Q÷UIEC@EFQHQTMPG`ITMJIBWB@F@BA@M@AIEGIMIMKCICQK[IIKISPsLQEKBEBYPe\\KFOBQFGDGJUJCBAF@DHLABIACB[LOD[@_AWGSQKOEQĹDÇSPerEDMDQ@OFS@cHMHm@CBĲÐdzhCH¦@BRTZNLHtXADA@[HM@UDBBHDAF@BTFJH@JDHDBN@NDJ@HHDBLBRAFBBDITLZ@DKRKL@DFDĎyļOd@BAAEBA`@VEdD\\@FDPCnRLCLANIPEjAPFbPBBBH',
            ],
            ['@@KKKFZHAA'],
          ],
          encodeOffsets: [[[100831, 40930]], [[100209, 40671]]],
        },
        properties: {
      ...
      },
      {
        ...
        properties: { cp: [106.684691, 35.54279], name: '平凉市', childNum: 5 },
      },
      {
        id: '620900',
        type: 'Feature',
